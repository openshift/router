...
var _ = g.Describe("[OTP][sig-network-edge] Network_Edge Component_Router", func() {
	...
	oc := exutil.NewCLIWithoutNamespace("load-balancer")
	...
	// author: hongli@redhat.com
	// Switching of AWS CLB to NLB requires manual service deletion since OCP 4.22
	g.It("Author:hongli-ROSA-OSD_CCS-High-52837-switching of AWS CLB to NLB requires manual service deletion", func() {
		...
		// It needs user intervention and manually delete the service since OCP 4.22
