...
func main() {
	...
	componentSpecs.AddBeforeAll(func() {
		...
		// Initialize CloudConfig.Provider to avoid nil pointer dereference
		// This must be called after InitTest and flag parsing
		e2e.AfterReadingAllFlags(&e2e.TestContext)
	})
