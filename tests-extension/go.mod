...
replace github.com/opencontainers/cgroups => github.com/opencontainers/cgroups v0.0.3

replace github.com/google/cadvisor => github.com/google/cadvisor v0.52.1
