...
`)
	...
	g.It("Author:aiyengar-ROSA-OSD_CCS-ARO-High-41042-The Power-of-two balancing features defaults to random LB algorithm instead of leastconn for REEN/Edge/insecure routes", func() {
		var (
			baseDomain   = getBaseDomain(oc)
	...
	// author: hongli@redhat.com
	g.It("Author:hongli-Critical-47344-check haproxy router v4v6 mode", func() {
