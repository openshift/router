...
var (
	...
	FeatureGateRouteCertificateReference = FeatureGateName("RouteCertificateReference")
	routeCertificateReference            = FeatureGateDescription{
		FeatureGateAttributes: FeatureGateAttributes{
			Name: FeatureGateRouteCertificateReference,
		},
