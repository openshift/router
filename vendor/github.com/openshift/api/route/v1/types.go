...
type TLSConfig struct {
	...
	// be present in the same namespace as that of the Route. If certificateRef
	// provided, do not set certificate.
	//
	// +openshift:enable:FeatureSets=TechPreviewNoUpgrade
	// +optional
	CertificateRef LocalObjectReference `json:"certificateRef,omitempty" protobuf:"bytes,7,opt,name=certificateRef"`
}
