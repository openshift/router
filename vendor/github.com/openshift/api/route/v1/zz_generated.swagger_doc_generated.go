...
var map_TLSConfig = map[string]string{
	...
	"certificate":                   "certificate provides certificate contents. This should be a single serving certificate, not a certificate chain. Do not include a CA certificate. If certificate is provided, do not set certificateRef.",
	...
	"certificateRef":                "certificateRef provides certificate contents as a secret reference. This should be a single serving certificate, not a certificate chain. Do not include a CA certificate. The secret referenced should be present in the same namespace as that of the Route. If CertificateRef provided, do not set certificate.",
}
