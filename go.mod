...
require (
	...
	github.com/openshift/openshift-tests-private v0.0.0-20260214075654-3f9723c60a76
	github.com/openshift/origin v1.5.0-alpha.3.0.20260213184050-3cec87cb4ad5
...
replace (
	...
	k8s.io/externaljwt => github.com/openshift/kubernetes/staging/src/k8s.io/externaljwt v0.0.0-96593f323733
