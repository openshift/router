...
require (
	...
	github.com/openshift/openshift-tests-private v0.0.0-20260227074532-ab85ec749dad
	github.com/openshift/origin v1.5.0-alpha.3.0.20260227052735-512dc6d4da2e
