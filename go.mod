...
require (
	...
	github.com/openshift/openshift-tests-private v0.0.0-20260306214426-9d48973a34f8
	github.com/openshift/origin v1.5.0-alpha.3.0.20260306181616-35bab742394d
