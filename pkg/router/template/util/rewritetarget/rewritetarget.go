...
// in spec.path to be treated as regex meta characters. This fix wraps the <match-regex> argument in single
// quotes and sanitizes spec.path by escaping single quotes, regex meta characters, and new line characters
